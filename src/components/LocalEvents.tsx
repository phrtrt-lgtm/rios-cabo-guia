...
const localEvents: LocalEvent[] = [
  ...
  },
  {
    id: "3",
    title: {
      pt: "Show de Verão - Praia do Forte",
      en: "Summer Concert - Praia do Forte",
      es: "Show de Verano - Praia do Forte",
    },
    description: {
      pt: "Shows gratuitos com artistas regionais e nacionais na orla de Cabo Frio.",
      en: "Free concerts with regional and national artists on Cabo Frio's waterfront.",
      es: "Shows gratuitos con artistas regionales y nacionales en el paseo marítimo de Cabo Frio.",
    },
    date: "2026-01-18",
    time: "20h-00h",
  ...
  },
  {
    id: "4",
    title: {
      pt: "Festival Gastronômico de Verão",
      en: "Summer Food Festival",
      es: "Festival Gastronómico de Verano",
    },
    description: {
      pt: "Restaurantes locais com pratos especiais de verão e frutos do mar.",
      en: "Local restaurants with special summer dishes and seafood.",
      es: "Restaurantes locales con platos especiales de verano y mariscos.",
    },
    date: "2026-01-10",
    endDate: "2026-01-25",
    location: "Boulevard Canal - Cabo Frio",
    category: "gastronomy",
  },
  {
    id: "5",
    title: {
      pt: "Roda de Samba na Passagem",
      en: "Samba Circle at Passagem",
      es: "Roda de Samba en Passagem",
    },
    description: {
      pt: "Samba ao vivo com grupos locais às sextas-feiras de verão.",
      en: "Live samba with local groups on summer Fridays.",
      es: "Samba en vivo con grupos locales los viernes de verano.",
    },
    date: "2026-01-17",
    time: "19h-23h",
    location: "Bairro Passagem",
    category: "music",
    recurring: true,
  },
  {
