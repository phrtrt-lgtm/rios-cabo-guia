      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-medium">Horário:</span> {recommendedTime}
          </div>

          <div className="flex items-center gap-2 text-sm">
            <MapPin className="h-4 w-4 text-muted-foreground" />
            <span className="font-medium">Início:</span> {startName}
          </div>
          ...
          <div className="flex items-start gap-2 text-sm text-amber-600">
            ...
            <div>
              <span className="font-medium">Avisos:</span> {warnings}
            </div>
          </div>
        </div>

        <div className="pt-2 border-t">
          <p className="text-xs text-muted-foreground mb-2">Tempo estimado por pace:</p>
